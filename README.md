...
- **Django REST Framework (DRF)**: A powerful toolkit for building Web APIs, used to create the API endpoints.
- **SQLite**: The default database used for storing data during development; can be replaced with other databases like PostgreSQL in production.
- **Token Authentication**: Provided by Django REST Framework for user authentication, allowing users to securely access their data.
- **Django REST Framework SimpleJWT**: For implementing JSON Web Token (JWT) authentication.
## API Endpoints
